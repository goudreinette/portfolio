...
if ( $attachment_ids ) {
	?>
	<div id="product-thumbnails" class="carousel slick product-thumbnails" data-navigation="false" data-autoplay="false" data-columns="5" data-asnavfor="#product-images">
	<?php

<?php
	...
	$columns = array_key_exists('columns', $vars) ? $vars['columns'] : false;
?>
<div class="small-12 medium-6 <?php echo esc_attr($columns); ?> columns">
	<article itemscope itemtype="http://schema.org/Article" <?php post_class('post style6 style6-alt'); ?> role="article">

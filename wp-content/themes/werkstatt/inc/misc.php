...
function thb_body_classes( $classes ) {
	...
	$color_changing_header = 'color-changing-header-' . get_post_meta($thb_id, 'disable_header_fill', TRUE);
...
add_action( 'thb_social_links', 'thb_social', 3 , 1 );

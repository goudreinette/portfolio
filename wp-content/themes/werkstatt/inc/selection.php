...
<?php
	...
	if ($posts->have_posts()) :  while ($posts->have_posts()) : $posts->the_post();
		...
		?>
			...
			.thb-portfolio #portfolio-<?php echo esc_attr($thb_id); ?>.type-portfolio:not(.thb-gradient-hover) .portfolio-link,

...
vc_add_param("vc_row", array(
	...
	'weight' => 1,
	"description" => esc_html__("You can specify a video background file here (mp4)", "werkstatt")
));
vc_add_param("vc_row", array(
	"type" => "colorpicker",
...
vc_map( array(
	...
	"params"	=> array(
	  ...
	  array(
	      ...
	      "admin_label" => true,
	      "description" => esc_html__("Enter the portfolio IDs you would like to display seperated by comma <small>Please add minimum of 4 IDs for masonry layouts</small>", "werkstatt")
	  ),
	  array(
	      "type" => "dropdown",
...
vc_map( array(
	...
	"params"	=> array(
	  ...
	  array(
	      ...
	      "description" => esc_html__("Hover Style", "werkstatt")
	  ),
	),
...
vc_map( array(
	...
	"params"	=> array(
	  array(
	      "type" => "textfield",
	      "class" => "",
	      "heading" => esc_html__("Number of posts", "werkstatt"),
	      "param_name" => "item_count",
	      "value" => "4",
	      "description" => esc_html__("The number of posts to show.", "werkstatt")
	  ),
	  array(
	  	"type" => "dropdown",
	  	"heading" => esc_html__("Style", "werkstatt"),

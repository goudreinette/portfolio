<?php
	...
	$class[] = $main_color_title;
?>
<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" <?php post_class($class); ?> id="portfolio-<?php the_ID(); ?>" data-color="<?php echo esc_attr($main_color_title); ?>">
	<div class="portfolio-holder">
		<div class="portfolio-content">
			<h2><?php the_title(); ?></h2>
			<aside class="thb-categories"><?php echo esc_html($categories); ?></aside>
			<div class="thb-excerpt"></div>
		</div>
	</div>
</a>
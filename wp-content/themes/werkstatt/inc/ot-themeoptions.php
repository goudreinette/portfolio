  ...
  $custom_settings = array(
    ...
    'settings'        => array(
      ...
      array(
        ...
        'type'        => 'text',
        'desc'        => sprintf(esc_html__('Visit %1$sthis link%2$s in a new tab, sign in with your Instagram account, click on Create a new application and create your own keys in case you dont have already. After that, you can get your Access Token using %3$shttp://labs.themeinity.com/plugins/tools/instagram/%4$s', 'werkstatt' ),
        	'<a href="http://instagr.am/developer/register/">',
        	'</a>',
        	'<a href="http://labs.themeinity.com/plugins/tools/instagram/">',
        	'</a>'
        	),
        'section'     => 'misc'
      ),
